...
OUTPUT_DIR="${3:-hdfs://localhost:9000/flight-delay-project/output/spark_core/analysis_1_${DATASET_LABEL}}"
PREVIEW_PATH="${4:-results/tables_hdfs/spark_core_analysis_1_${DATASET_LABEL}_preview.csv}"
...
spark-submit --master local[*] spark_core/analysis_1_airline_stats.py \
